...
if("TRUE" STREQUAL "TRUE")
  set(head_pose_estimation_SOURCE_PREFIX /home/human/ros_catkin_ws/src/head_pose_estimation)
  set(head_pose_estimation_DEVEL_PREFIX /home/human/ros_catkin_ws/devel)
  ...
  set(head_pose_estimation_INSTALL_PREFIX /home/human/ros_catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'head_pose_estimation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Miguel Sarabia <miguel.sarabia@imperial.ac.uk>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'head_pose_estimation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/human/ros_catkin_ws/src/head_pose_estimation/${idir}'.  Ask the maintainer 'Miguel Sarabia <miguel.sarabia@imperial.ac.uk>' to fix it.")
    endif()
...
set(head_pose_estimation_EXPORTED_TARGETS "")
